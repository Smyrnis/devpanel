...
#[test] fn parse_comment_only_returns_empty() { assert!(parse_vhosts_from_content("# DevPanel managed VirtualHosts\n").is_empty()); }
#[test] fn parse_single_vhost_no_php() {
...
#[test] fn parse_multiple_vhosts_assigns_sequential_indexes() {
...
#[test] fn build_single_entry_with_php_produces_sethandler() {
...
#[test] fn round_trip_parse_build_parse_is_stable() {
    let original = vec![
...
#[test] fn round_trip_trailing_slash_stripped_from_server_name() {
...
#[test] fn vhost_entry_is_partial_eq() {

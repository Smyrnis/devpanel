// when the log system is used remove the dead_code overrides ... 
...
impl SetupLogEntry {
    ...
    pub fn parse(line: &str) -> Option<Self> {
        ...
        Some(SetupLogEntry { timestamp, level, message })
    }
}
#[allow(dead_code)]
pub fn read_setup_log() -> Vec<SetupLogEntry> {
    ...
    content
        .lines()
        .filter_map(SetupLogEntry::parse)
        .collect()
}
#[allow(dead_code)]
